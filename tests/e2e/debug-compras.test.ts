...
describe('Debug: Compras Este Mes', () => {
    ...
    it('COMPARACIÓN FINAL', async () => {
        ...
        const execNoGroup = await executeQueries(odoo, CEDENT_TENANT_ID, [{
            model: 'purchase.report',
            operation: 'aggregate',
            groupBy: [],
            dateRange: { start: startOfMonth, end: endOfMonth }
        ...
        const execWithGroup = await executeQueries(odoo, CEDENT_TENANT_ID, [{
            model: 'purchase.report',
            operation: 'aggregate',
            groupBy: ['partner_id'],
            dateRange: { start: startOfMonth, end: endOfMonth }
